...
{
    public class PaqueteriaDHL : IPaqueterias
    {
        private readonly ITransporteFabrica transporteFabrica;

        private ITransporte transporte = null;
        RequestPaqueteriaDHL RequestPaqueteria = new RequestPaqueteriaDHL();

        public PaqueteriaDHL(ITransporteFabrica _transporteFabrica)
        {
